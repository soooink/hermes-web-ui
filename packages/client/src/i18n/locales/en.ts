export default {
  ...
  login: {
    ...
    totpLogin: 'Authenticator',
    totpRequired: 'Please enter the 6-digit code',
    invalidTotp: 'Invalid authenticator code',
    totpPlaceholder: '000000',
    totpTitle: 'Two-Factor Authentication',
    totpDescription: 'Use an authenticator app (Google Authenticator, 1Password, etc.) for an additional security layer.',
    totpSetup: 'Set Up Authenticator',
    totpDisable: 'Disable',
    totpRemoveConfirm: 'Are you sure you want to disable authenticator login? You can still use your token or password.',
    totpNotConfigured: 'Authenticator login is not configured',
    totpConfigured: 'Authenticator login is enabled',
    totpRemoved: 'Authenticator login disabled',
    totpSetupSuccess: 'Authenticator configured successfully',
    totpActivationFailed: 'Invalid code. Please try again.',
    totpActivationCodeRequired: 'Please enter the 6-digit activation code',
    totpActivationCodePlaceholder: 'Enter 6-digit code',
    totpScanInstructions: 'Scan this QR code with your authenticator app:',
    totpManualEntry: 'Or enter this key manually:',
  },
