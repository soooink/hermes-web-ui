export default {
  ...
  login: {
    ...
    totpLogin: '验证器',
    totpRequired: '请输入6位验证码',
    invalidTotp: '验证码无效',
    totpPlaceholder: '000000',
    totpTitle: '双重认证',
    totpDescription: '使用验证器应用（Google Authenticator、1Password 等）增加安全层。',
    totpSetup: '设置验证器',
    totpDisable: '禁用',
    totpRemoveConfirm: '确定要禁用验证器登录吗？您仍可使用令牌或密码登录。',
    totpNotConfigured: '验证器登录未配置',
    totpConfigured: '验证器登录已启用',
    totpRemoved: '验证器登录已禁用',
    totpSetupSuccess: '验证器配置成功',
    totpActivationFailed: '验证码无效，请重试',
    totpActivationCodeRequired: '请输入6位激活码',
    totpActivationCodePlaceholder: '输入6位验证码',
    totpScanInstructions: '使用验证器应用扫描此二维码：',
    totpManualEntry: '或手动输入此密钥：',
  },
